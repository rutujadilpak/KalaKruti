    ...
    const finishTypes = [
        {
            ...
            description: "Durable and cost-effective finishes available in a wide range of colors and patterns.",
            image: "https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80",
            features: ["Scratch Resistant", "Easy to Clean", "Moisture Resistant"],
            price: "Starting from ₹800/sq ft"
        },
        {
            id: 2,
            title: "Wood Veneer Finishes",
            description: "Natural wood veneers that bring warmth and elegance to your kitchen design.",
        ...
        },
        {
            ...
            description: "Sleek, reflective surfaces that create a modern and sophisticated kitchen aesthetic.",
            image: "https://images.unsplash.com/photo-1616486338812-3dadae4b4ace?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80",
            features: ["High Shine", "Easy Maintenance", "Contemporary Style"],
            price: "Starting from ₹1,500/sq ft"
        },
        {
            id: 4,
            title: "Matte Finishes",
            description: "Soft, non-reflective surfaces that provide a subtle and elegant kitchen appearance.",
            image: "https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80",
            ...
            <Container maxWidth="lg">
                ...
                <Box sx={{ mb: 4 }}>
                    ...
                    <Typography variant="h6" color="text.secondary" sx={{ mb: 3 }}>
                        Explore our premium range of finishes to create the perfect look for your kitchen
                    </Typography>
                </Box>
                ...
                >
                    ...
                    <Typography variant="body1" color="text.secondary" sx={{ mb: 3 }}>
                        Visit our showroom to touch and feel our premium finishes and make the perfect choice for your kitchen.
                    </Typography>
                    <Button
                        variant="contained"
                        size="large"
